...
then
    ...
    mail -s "warn|server: $MYSQLIP mysql is down" email_address@163.com
fi
...
　  mail -s "warn! $MySQLIP_replicate_error" email_address@163.com << /data/log/check_mysql_slave.log
